...
my_data <- NEI[my_data,]
my_data <- subset(my_data, my_data$fips == "24510")
...
png("~/prog/R_proj/exp_analysis/Proj_2/exdata-data-NEI_data/plot5.png")

par(pch=22)
plot(my_data$year, my_data$emission, xlab="Year", ylab="Total Emissions", xaxt = "n", main = "Total Emissions from Coal in Baltimore City")
